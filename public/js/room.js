...
// import Dictaphone1 from '../speechtotext/dictaphone';
...
const saveAudioBtn = document.querySelector('#saveaudiohref');
...
function startCall() {
    ...
    navigator.mediaDevices.getUserMedia(mediaConstraints)
        .then(localStream => {
            ...
            //     language: 'en-GB',
            // });
            console.log("In startcall fun, before code")
...
const handleSuccess = function(stream) {
    console.log("In Handle Sucess Fun")
